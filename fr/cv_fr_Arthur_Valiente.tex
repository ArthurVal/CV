...
\newcommand\skills{
  \smartdiagram[bubble diagram]{
    \textbf{\large Ingénieur}\\\textbf{\large Embarqué}\\\textbf{\large Robotique},
    ...
    \textbf{\large Contrôle}\\\textbf{\large Optimal}
  }
}
...
\cvjobtitle{ \textbf{Ingénieur INP-ENSEEIHT} \\ Systèmes Embarqués \\ Robotique - Automatique} % Job
% title/career

...
~
	\smartdiagram[bubble diagram]{
        ...
        \textbf{\large R.O.S.}\\\textbf{Intergiciel},
        \textbf{GNU/Linux}\\\textbf{Yocto},
        \textbf{\large Kalman}\\\textbf{EKF | UKF},
        \textbf{\large Embarqué}\\\textbf{ARM-GPU},
        \textbf{\large SLAM}
    }
}
...
\programming{
  ...
  {Bash $\textbullet$ Shell $\textbullet$ CMake $\textbullet$ Make / 3.5},
...
\cvjobtitle{ Ingénieur INP-ENSEEIHT \\ Robotique - Automatique \\ Systèmes Embarqués} % Job
% title/career

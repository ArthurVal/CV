...
\begin{twenty} % Environment for a list with descriptions
  ...
  {\cea-DRF-IRFU, Saclay}
  {
    \textbf{\href{http://www.svom.fr/}{Projet SVOM}}: Responsable du banc de test logiciel embarqué caméra ECLAIRs
    \begin{itemize}
    ...
    \item En charge de la création/rédaction des scripts de tests unitaires Python
    \end{itemize}
  }
  \\
  \twentyitem
  ...
  {\cea-DRT-LIST, Saclay}
  {
    ...
    \item \textbf{\href{http://www.cea.fr/Pages/actualites/CES-2019.aspx?Type=Chapitre&numero=5}{Projet FACE}}: Création d'applications C++ pour prototype
